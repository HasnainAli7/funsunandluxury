...
const otherPageChildMenus: NavItemType[] = [
  ...
  { id: ncNanoId(), href: "/Dashboard", name: "Dashboard" },
];

const templatesChildrenMenus: NavItemType[] = [
  {
    id: ncNanoId(),
    href: "/add-venue-listing" as Route,
    name: "Venue Listing",
    // type: "dropdown",
    // children: [
    //   {
  ...
  {
    id: ncNanoId(),
    href: "/add-pool-listing" as Route,
    name: "Pool Listing",
    // type: "dropdown",
    // children: [
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/1" as Route,
    //     name: "Add listing 1",
    //   },
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/2" as Route,
    //     name: "Add listing 2",
    //   },
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/3" as Route,
    //     name: "Add listing 3",
    //   },
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/4" as Route,
    //     name: "Add listing 4",
    //   },
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/5" as Route,
    //     name: "Add listing 5",
    //   },
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/6" as Route,
    //     name: "Add listing 6",
    //   },
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/7" as Route,
    //     name: "Add listing 7",
    //   },
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/8" as Route,
    //     name: "Add listing 8",
    //   },
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/9" as Route,
    //     name: "Add listing 9",
    //   },
    //   {
    //     id: ncNanoId(),
    //     href: "/add-listing-pool/10" as Route,
    //     name: "Add listing 10",
    //   },
    // ],
  },
